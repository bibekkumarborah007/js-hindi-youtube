...
//search: object iteration property



//task:
// To modify Math.PI to 3.4, you need to set configurable: true first (which is not possible in most environments).
// But if configurable is true, you can redefine it as follows:

// You cannot redefine Math.PI, so create your own constant instead
const MY_PI = 3.4;

console.log(MY_PI); // Output: 3.4
