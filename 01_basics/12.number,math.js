...
// console.log(otherNumber.toPrecision(3)); //23.9 use only when we know upto value as large number before decimal can give exponential value
...
// console.log(Math.min(2,5,1,5,7,1,10)//1
